...
/* package empty-gloss-game-project-0.1.0.0 */
#define VERSION_empty_gloss_game_project "0.1.0.0"
#define MIN_VERSION_empty_gloss_game_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "empty-gloss-game-project-0.1.0.0"

#define CURRENT_PACKAGE_KEY "empty-gloss-game-project-0.1.0.0"
